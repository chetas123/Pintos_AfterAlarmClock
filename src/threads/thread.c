...
/* Inserts thread in the proper position in LIST in descending order by priorities.
   Runs in O(n) average case in the number of elements in LIST. */
void
thread_insert_ordered (struct list *list, struct list_elem *elem)
{
  struct list_elem *e;
